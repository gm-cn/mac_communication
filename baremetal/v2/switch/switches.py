...
import logging
import abc
from baremetal.v2.switch import cisco_ssh, cisco_telnet, huawei_ssh, huawei_telnet
...
def switch_plugin_v2():
    switch_plugin = SwitchConfigure()
    return switch_plugin.create_plugin()